...
- **[zp-4](https://github.com/zp-4)** — author of the [Contribution](#contribution) items above in this repository.

The upstream project credits Ibrahim Talbi; see history and `NOTICE` for original authorship.
